package com.nikolaevskii.lyte.feature.tracker.data.mapper

import com.nikolaevskii.lyte.core.db.session.ProgramLastSessionRow
...
import com.nikolaevskii.lyte.feature.tracker.data.model.SessionRowsModel
...
internal fun ProgramLastSessionRow.toDomainEntity(): LastSessionDateEntity =
    LastSessionDateEntity(
        programId = programId,
        finishedAt = Instant.fromEpochMilliseconds(finishedAt),
    )
