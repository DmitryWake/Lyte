package com.nikolaevskii.lyte.feature.tracker.data.repository
...
import com.nikolaevskii.lyte.feature.tracker.data.mapper.toDomainEntity
import com.nikolaevskii.lyte.feature.tracker.data.mapper.toItemEntity
import com.nikolaevskii.lyte.feature.tracker.data.mapper.toSessionRows
...
internal class WorkoutSessionRepositoryImpl(
    ...
    override suspend fun getLastSessionDates(): List<LastSessionDateEntity> =
        workoutSessionDao.getLastSessionDates().map { it.toDomainEntity() }
