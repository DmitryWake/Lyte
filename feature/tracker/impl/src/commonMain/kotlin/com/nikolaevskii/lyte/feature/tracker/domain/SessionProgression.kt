 ...
 */
internal fun WorkoutSessionEntity.effectiveCurrentExercise(): SessionExerciseEntity? {
...
internal fun SessionExerciseEntity.currentSet(): SessionSetEntity? =
    sets.firstOrNull { set -> set.result == null }

/** Есть ли в упражнении незакрытые подходы. Упражнение без подходов считается закрытым. */
internal fun SessionExerciseEntity.hasPendingSets(): Boolean =
