 ...
 * подходов, шторка выбора упражнения из библиотеки или шторка создания нового. Sealed-модель заменяет
 * пару независимых nullable-полей (`editingExerciseIndex` + `exerciseSheet`) — два оверлея одновременно
 * теперь невыразимы по построению.
 */
