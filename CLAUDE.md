...
- Тесты живут в модулях, где есть логика: `:core:core-mvi`, `:core:core-db`, `:core:core-app`, `:core:core-workout`, `:core:core-session`, `:feature:{tracker,workout,history,splash}:impl`. Гейт (гонять перед коммитом/релизом, macOS):
