package com.nikolaevskii.lyte.core.session.domain.util
 ...
 *
 * Правила: вес сравнивается только для весовой цели ([hasWeight]); [com.nikolaevskii.lyte.core.session.domain.model.SessionSetOutcomeEntity.MET] —
 * все сравниваемые измерения ровно в цель; [com.nikolaevskii.lyte.core.session.domain.model.SessionSetOutcomeEntity.EXCEEDED] — ни одно не ниже и
 * хотя бы одно выше; [com.nikolaevskii.lyte.core.session.domain.model.SessionSetOutcomeEntity.MISSED] — хотя бы одно ниже цели.
 */
